...
create table PAYMENT_INFORMATION (ID integer not null auto_increment, AMOUNT float(9,2) not null, APPROVED bit(1) default b'0', APPROVED_AT datetime, DESCRIPTION varchar(255), PAID_AT datetime, APPROVED_BY integer, BILL_ID integer, primary key (ID)) engine=InnoDB;

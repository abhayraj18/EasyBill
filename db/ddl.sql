...
create table ORDER_INFO (ID integer not null auto_increment, DESCRIPTION varchar(255), MODIFIED_ON datetime not null, ORDER_DATE datetime not null, ORDER_NUMBER varchar(50) not null, STATUS enum ('ACTIVE', 'INACTIVE') not null, USER_ID integer not null, primary key (ID)) engine=InnoDB;
